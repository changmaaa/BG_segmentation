...
class Dual_SwinUNETR(nn.Module):
    """
    ...
    def __init__(
        ...
        self.decoder5 = UnetrUpBlock(
            spatial_dims=spatial_dims,
            in_channels=32 * feature_size, ############################원래 16
            out_channels=16 * feature_size, 
            kernel_size=3,
        ...
        self.out = UnetOutBlock(spatial_dims=spatial_dims, in_channels=feature_size*2, out_channels=out_channels)
...
#         print(x1.shape)
        x2 = x[:,1:,:,:,:]
#         print(x2.shape)
        hidden_states_out1 = self.swinViT(x1, self.normalize)
        hidden_states_out2 = self.swinViT(x2, self.normalize)
        enc0_1 = self.encoder1_1(x1)
        enc0_2 = self.encoder1_2(x2)
#         print(enc0_1.shape)
        enc0 = torch.cat((enc0_1, enc0_2), dim=1)
#         print(enc0.shape)
        enc1_1 = self.encoder2_1(hidden_states_out1[0])
        enc1_2 = self.encoder2_2(hidden_states_out2[0])
#         print(enc1_1.shape)
        enc1 = torch.cat((enc1_1, enc1_2), dim=1)
#         print(enc1.shape)
        enc2_1 = self.encoder3_1(hidden_states_out1[1])
        enc2_2 = self.encoder3_2(hidden_states_out2[1])
#         print(enc2_1.shape)
        enc2 = torch.cat((enc2_1, enc2_2), dim=1)
#         print(enc2.shape)
        enc3_1 = self.encoder4_1(hidden_states_out1[2])
        enc3_2 = self.encoder4_2(hidden_states_out2[2])
#         print(enc3_1.shape)
        enc3 = torch.cat((enc3_1, enc3_2), dim=1)
#         print(enc3.shape)
        dec4_1 = self.encoder10_1(hidden_states_out1[4])
        dec4_2 = self.encoder10_2(hidden_states_out2[4])
#         print(dec4_1.shape)
        dec4 = torch.cat((dec4_1, dec4_2), dim=1)
#         print(dec4.shape)
        hidden_states_out = torch.cat((hidden_states_out1[3], hidden_states_out2[3]), dim=1)
        dec3 = self.decoder5(dec4, hidden_states_out)
#         print(dec3.shape)
